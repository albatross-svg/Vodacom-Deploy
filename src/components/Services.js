                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            font-bold">We <span className='font-black'>DOTHIS</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Accusantium, cum repudiandae! Commodi tempora nostrum consequatur exercitationem recusandae in animi et iusto doloribus, debitis quod quasi, a odit quam, corrupti tenetur.
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <h3 className="text-3xl  text-blue-900 font-bold">We <span className='font-black'>DOTHIS</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti aliquid eum repellendus amet, sapiente libero quas et beatae facere, accusantium esse quisquam consequuntur quibusdam pariatur a quae assumenda nemo totam!</p>
                            </div>
                        </div>
                    </div>
                </div>
