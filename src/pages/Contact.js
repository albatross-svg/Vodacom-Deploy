...
import emailjs from 'emailjs-com'; // Uncommented EmailJS
...
const Contact = () => {
    ...
    const validateForm = () => {
        ...
        if (!formData.phone.trim() || formData.phone.length < 10) newErrors.phone = 'Invalid phone number';
                        ...
                        <div className="flex flex-col text-white">
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">Tel: 0911121314</p>
                                    <div className="mt-5">
                                        <h2 className="text-2xl">Send an E-mail</h2>
                                        <p className="text-gray-400">info@orgname.com</p>
                                    </div>
                                </div>
                            </div>
                            <div className="flex my-4 w-2/3 lg:w-1/2">
